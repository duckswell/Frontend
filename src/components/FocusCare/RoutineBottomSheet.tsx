...
const ROUTINE_OPTIONS = [
  ...
  },
  {
    ...
    steps:
      "예) 진정 클렌징 → 토너 → 추천 세럼 → 마스크팩 → 크림 → 추가 관리",
  },
];
...
export default function RoutineBottomSheet() {
  ...
  const [selectedRoutine, setSelectedRoutine] =
    useState<RoutineLevel | null>(null);
  ...
  return (
    ...
    >
      ...
      <S.SheetContent $expanded={isExpanded}>
        ...
        <S.ButtonArea>
          <CareButton onClick={handleStartRoutine}>
            선택한 루틴 시작하기
          </CareButton>
        </S.ButtonArea>
      </S.SheetContent>
